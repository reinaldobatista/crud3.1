...
<div class="flex-dashboard">
    ...
    <main>
        ...
        <div class="main-content">   
                <div class="panel-row">
                <a href="#">
                        <button class="panel panel-50" a-view="cadastraProduto" a-folder="produto" onclick="fetchContent(this)">Cadastra Produto</button>
                    </a>
                <a href="#">
                         <button class="panel panel-50" a-view="visualizarProduto"  onclick="fetchContent(this)" a-folder="produto" >Visualizar produto</button>
                    </a>
                </div>
